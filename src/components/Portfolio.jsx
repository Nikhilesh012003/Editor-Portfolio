...
import { Play, ExternalLink, X, Youtube, Instagram, Film, Video } from "lucide-react";
    ...
    >
      ...
      >
        <img
          ...
          onError={(e) => { e.target.src = "https://via.placeholder.com/800x200?text=Channel+Preview"; }}
        />
      </a>
    </motion.div>
  );
  ...
  return (
    <section id="portfolio" className="py-24 bg-white" ref={ref}>
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <span className="text-amber-500 font-semibold text-sm tracking-widest uppercase">My Work</span>
